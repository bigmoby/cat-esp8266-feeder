...
WiFiMQTTManager::WiFiMQTTManager(int resetPin, char* APpassword) {
  ...
  subscribeTo = _placeholderSubscribeTo;
  //void _placeholderBirthMessage();
  //birthMessage = _placeholderBirthMessage;
...
void _placeholderSubscribeTo() {
  Serial.println("WMM: ....placeholderSubscribeTo called...");
}

void _placeholderBirthMessage() {
  Serial.println("WMM: ...._placeholderBirthMessage called...");
}
