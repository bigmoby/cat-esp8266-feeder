...
void Stepper::step(int steps_to_move)
{
  ...
  while (steps_left > 0)
  {
    delay(0); // Hacked version of Stepper library in order to avoid soft reset in ESP8266
...
void Stepper::stepMotor(int thisStep)
{
  ...
  // Hacked sequence in order to rootare CW and CCW too (for 28BYJ-48 stepper model). Many thanks to Mauro Alfieri: https://www.mauroalfieri.it/elettronica/stepper-28byj-48-arduino.html
  if (this->pin_count == 4) {
    switch (thisStep) {
      case 0:  // 1100
        digitalWrite(motor_pin_1, HIGH);
